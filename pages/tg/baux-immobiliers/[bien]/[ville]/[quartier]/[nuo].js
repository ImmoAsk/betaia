    ...
    axios.get('/api/graphql', { params: { query } }).
      then((res) => {
        ...
        setRecommendProperties(properties.map((propertyr) => {
          ...
          return {
            href: getPropertyFullUrl(paysCode, propertyr.offre.denomination, propertyr.categorie_propriete.denomination, propertyr.ville.denomination, propertyr.quartier.minus_denomination, propertyr.nuo),
              ...
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item">
                  <Link href="/tg/baux-immobiliers">
                    <a>Baux immobiliers</a>
                  </Link>
                </li>
                <li className="breadcrumb-item">
                  <Link href={`/tg/baux-immobiliers/${bien}`}>
                    <a>{property.categorie_propriete.denomination}</a>
                  </Link>
                </li>
                <li className="breadcrumb-item">
                  <Link href={`/tg/baux-immobiliers/${bien}/${ville}`}>
                    <a>{property.ville.denomination}</a>
                  </Link>
                </li>
                <li className="breadcrumb-item">
                  <Link href={`/tg/baux-immobiliers/${bien}/${ville}/${quartier}`}>
