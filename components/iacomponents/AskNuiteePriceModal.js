      ...
      <Modal.Body className='px-0 py-2 py-sm-0'>
        ...
        <div className='row mx-0 align-items-center'>
          <div className='col-md-6 border-end-md p-4 p-sm-5'>
            <h2 className='h3 mb-4 mb-sm-5'>Demande de Nuitée : N°{property.nuo} {property.categorie_propriete.denomination} à {property.offre.denomination} | {property.surface} m²</h2>
