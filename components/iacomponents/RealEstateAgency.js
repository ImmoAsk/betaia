...
export default function RealEstateAgency() {
    ...
    <>
        ...
        <Card className='card-horizontal'>
            <div className='card-img-top bg-size-cover bg-position-center-x' style={{ backgroundImage: `url(http://127.0.0.1:8000/storage/uploads/visuels/organisations/${organisation.logo})` }}></div>
