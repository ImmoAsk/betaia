...
const EditProperty = ({ propriete }) => {
    ...
    const buildAppendMapFileUpload = (event) => {
        ...
        //let updateURL= 'http://127.0.0.1:8000/api/v2?query=mutation{updatePropriete(input:{id:1435,cuisine:1,est_meuble:1,salon:1,piece:3,etage:0,wc_douche_interne:2,nuitee:35000}){id,cuisine,est_meuble,piece,salon,wc_douche_interne}}'
